...
Under development using Godot 4.1.2.
...
Requires plugin [ivoyager_table_reader](https://github.com/ivoyager/ivoyager_table_importer) v0.0.6-dev (_master_ branch has translation file for number & unit names missing in v0.0.5).
