...
##
## See also [IVOrbit] for orbital mechanics (including static methods),
## [IVPhotometry] for visible-light anchors and conversions, and
## [IVSunOcclusionManager] for sun-occlusion (eclipse/shadow) math.[br][br]
##
