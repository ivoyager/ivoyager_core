...
# quantities to specific units for GUI display (FROM internal).
#
# You should never need to convert units in your internal processing!
#
# See static/qformat.gd for GUI display of unit strings.
#
...
# autoload or static 'Units' class if you need different unit constants.
...
func is_valid_unit(unit: StringName, multipliers_ := multipliers, lambdas_ := lambdas,
